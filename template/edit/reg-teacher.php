...
<body>
    <div class="container">
        <form action="<?PHP if($user->isLoggedIn()): ?>/saveRegistered.php<?PHP else: ?>/teacher/offer<?PHP endif; ?>" enctype="multipart/form-data" class="form-horizontal" method="post" action="#">
            <fieldset>
